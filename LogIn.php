...
<div class ="inputs">
 <input type = 'text' id = 'txtuser' name ='txtusername' placeholder="Admin Username" style ="font-size: 15; 
 height: 50px; 
 width: 250px;
 border-radius: 10px; 
...
">
 ...
 <input type = 'submit' value= "Log in" class ="Login"  name = 'btnlogin' >

</form>

<a href = "adminreg.php"  >  <input type="button" value="Register Account" ></a>
